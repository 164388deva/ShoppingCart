...
<%@page  import="java.util.ArrayList,com.deva.pojo.GroceryTable,com.deva.dao.GroceryDAO,com.deva.servlet.DisplayServlet" %>
<table border="1">
<tr>
<th>Product Name</th>
<th >Product Price</th>
</tr>
        <%ArrayList<GroceryTable> aList =(ArrayList<GroceryTable>)request.getAttribute("arrayList"); 
       
        for(GroceryTable Gtable:aList){%> 
         <tr>
            
          <td>  <%=Gtable.getName()%></td>
              <td>  <%=Gtable.getPrice()%> </td>
              </tr>  
            <%}%> 
