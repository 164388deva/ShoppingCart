...
<%@page  import="java.util.ArrayList,com.deva.pojo.FashionTable,com.deva.dao.GroceryDAO,com.deva.servlet.DisplayServlet" %>
<table border="1">
<tr>
<th>Product Name</th>
<th >Product Price</th>
<tr>
        <%ArrayList<FashionTable> FList =(ArrayList<FashionTable>)request.getAttribute("arrayList"); 
        for(FashionTable Ftable:FList){%> 
       
            <tr>
               <td> <%=Ftable.getName()%></td>
                <td><%=Ftable.getPrice()%> </td>
